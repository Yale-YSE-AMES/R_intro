...
#Author: Ethan Addicott   Email: ethan.addicott@yale.edu         #
##################################################################
...
###################PAUSE FOR A WORD OF ADVICE SLIDE##############
#EXAMPLE#
########

#Growing Result Vector
...
#EXTRA: What would adding a *;* do at the end of a line? 
#Try it on line 88
...
system.time(for (n in 1:length(sqr)) {sqr.squared[n] = sqr[n]^2})
#What is sapply? What does that even do? Try running edit(apply)
#to see what apply does. NOTE: sapply is related to apply, 
#the sapply edit page is less informative.
